...
* "mig.ucf" file is the constraint file for the design. This is used
...
* "bitgen_options.ut" file has the options for the Configuration file
  generation i.e. the "mig.bit" file to run in batch mode.
...
* "icon5_cg.xco", "ila384_8_cg.xco", "vio_async_in256_cg.xco" and
  ...
  i.e. ila, vio and icon and set DEBUG_PORT parameter to "ON" in mig
...
* At the start of a Chip Scope Analyzer project, all of the signals in
  every core have generic names. "mig.cdc" is a file that contains
  all the signal names of all cores. Upon importing this file, signal names are
  renamed to the specified names in "mig.cdc" file. This file will work
...
* "mig.prj" file has commands to add all rtl files to the XST project
  for synthesis.

* "mig.lso" file is a custom library search order file for XST synthesis.
